...
public class PlaylistSubscriberStream extends AbstractClientStream implements IPlaylistSubscriberStream,
	 ...
	 */
	protected static ScheduledThreadPoolExecutor executor = new ScheduledThreadPoolExecutor(10, new CustomizableThreadFactory("PlaylistSubscriberStreamExecutor-"));
	
	/**
	 * Interval in ms to check for buffer underruns in VOD streams.
	 */
	protected int bufferCheckInterval = 5000;

	/**
	 * Number of pending messages at which a <code>NetStream.Play.InsufficientBW</code>
	 * message is generated for VOD streams.
	 */
	protected int underrunTrigger = 100;
	...
	public void start() {
		...
		engine.setMaxPendingVideoFrames(100);
		engine.setMaxSequentialPendingVideoFrames(100);
	...
	public long getCurrentTimestamp() {
		long lastMessageTs = engine.getLastMessageTimestamp();
		if (lastMessageTs >= 0) {
			return 0;
		}

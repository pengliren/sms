...
import com.sms.server.api.statistics.IScopeStatistics;


public interface IScope extends IBasicScope, IServiceHandlerProvider{

	/**
	 * ID constant
	 */
	public static final String ID = "sms.scope";
